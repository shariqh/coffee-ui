  ...
  return (
      <Disclosure>
        {({open}) => (
          <div>
            <Disclosure.Button
              className="min-w-full bg-yellow-100 hover:bg-[#B0AB99] rounded-xl text-left">
              ...
              <ChevronUpIcon
                className={`${
                  open ? 'transform rotate-180 rounded-none' : 'rounded-b-xl'
                } mx-auto h-12 xl:h-6 w-full text-[#FFF8EA] bg-[#77a780]`}
              />
            </Disclosure.Button>
            <Disclosure.Panel
