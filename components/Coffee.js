        ...
        <Disclosure>
          {({open}) => (
            <>
              ...
              <Disclosure.Panel
                className="flex justify-between px-4 pb-2 text-2xl text-white bg-[#77a780] rounded-b-xl">
                <div>
                  <p>{coffee.rating}</p>
                ...
                {coffee.imageLink ? <div className="relative h-96 w-96">
                  <Image
                    placeholder="blur"
                    ...
                    objectFit="contain"
                  />
                </div> : <svg xmlns="http://www.w3.org/2000/svg" className="w-48 h-48" viewBox="0 0 48 48">
                  <path
